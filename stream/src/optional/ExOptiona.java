...
public class ExOptiona {

	public static void main(String[] args) {
		/*
		 * Optional
		 * 
		 * O objetivo da classe Optional no Java é fornecer uma abordagem mais segura e
		 * expressiva para tratar casos em que um valor pode ser ausente (nulo). Ela foi
		 * introduzida a partir do Java 8 para evitar o temido NullPointerException
		 * (NPE) que é comum quando se trabalha com referências nulas. Optional permite
		 * encapsular um valor que pode ser nulo dentro de um objeto Optional. Isso
		 * indica explicitamente que o valor pode ou não estar presente e requer que o
		 * código que deseja acessá-lo faça uma verificação explícita.
		 * 
		...
		String result1 = optionalValue8.orElseGet(() -> "Value from Supplier");
		System.out.println(result);
		...
		String result2 = optionalValue9.orElseThrow(() -> new RuntimeException("Value not present"));
		...
		optionalValue10.ifPresent(value -> System.out.println("Valor presente: " + value));
	}
